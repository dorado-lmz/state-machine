...
(function (StateJS) {
    var Behavior = (function () {
        ...
        Behavior.prototype.invoke = function (message, instance, history, callback) {
            ...
            var self = this;
            var array_actions = []; //contains all actions to execute serially
            this.actions.forEach(function (action) { return array_actions.push(function (cb) {
                if (StateJS.debug) {
...
(function (StateJS) {
    ...
    var InitialiseElements = (function (_super) {
        ...
        InitialiseElements.prototype.visitRegion = function (region, deepHistoryAbove) {
            ...
            this.behavior(region).leave.push(function (message, instance, history, cb) { _this.behavior(instance.getCurrent(region)).leave.invoke(message, instance); cb(null, 1); });
        ...
        InitialiseElements.prototype.visitState = function (state, deepHistoryAbove) {
            ...
            this.behavior(state).beginEnter.push(function (message, instance, history, cb) {
                if (state.region) {
...
(function (StateJS) {
    ...
    function create(cfg) {
        ...
        https: StateJS.console.log(statements);
