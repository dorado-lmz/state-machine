    ...
    function evaluateState(state, instance, message) {
        ...
        state.regions.every(function (region) {
            if (evaluateState(instance.getCurrent(region), instance, message)) {
                result = true;
                return StateJS.isActive(state, instance); // NOTE: this just controls the every loop; also isActive is a litte costly so using sparingly
            }
    ...
    var InitialiseElements = (function (_super) {
        ...
        InitialiseElements.prototype.visitElement = function (element, deepHistoryAbove) {
            if (StateJS.console !== defaultConsole) {
                this.behavior(element).leave.push(function (message, instance) { return StateJS.console.log(instance + " leave " + element); });
                this.behavior(element).beginEnter.push(function (message, instance) { return StateJS.console.log(instance + " enter " + element); });
            }
        };
        ...
        InitialiseElements.prototype.visitPseudoState = function (pseudoState, deepHistoryAbove) {
            ...
            if (pseudoState.isInitial()) {
                this.behavior(pseudoState).endEnter.push(function (message, instance) { return traverse(pseudoState.outgoing[0], instance); });
            }
        ...
        InitialiseElements.prototype.visitState = function (state, deepHistoryAbove) {
            ...
            state.regions.forEach(function (region) {
                ...
                _this.behavior(state).endEnter.push(_this.behavior(region).enter());
            });
